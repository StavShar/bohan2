...
def LagrangeMethod(others_table_points, point):
    ...
    yp = []
    result = 0
    print(bcolors.OKGREEN,"Starting Lagrange method..." , bcolors.ENDC)
    for i in range(len(others_table_points)):
    ...
    for i in range(len(others_table_points)):
        ...
        print(f"Interim result: {result} = {result} + ({lagrange_i} * {yp[i]})")
...
def cubic_spline_interpolation(table, target):
    ...
    d = []
    h = []
    print(bcolors.OKGREEN, "Starting Cubic spline method...", bcolors.ENDC)
...
def MainFunction():
    others_table_points = [(6.5, 2.14451), (6.7, 2.35585), (7.0, 2.74748), (8.0, 5.67127)]
    p0 = cubic_spilne_Point(6.5, 2.14451)
    p1 = cubic_spilne_Point(6.7, 2.35585)
    p2 = cubic_spilne_Point(7.0, 2.74748)
    p3 = cubic_spilne_Point(8.0, 5.67127)
